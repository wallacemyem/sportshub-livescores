...
import { getTeamBranding, fetchPublicTeamBadge } from '@/lib/flags';
...
export function TeamCrest({
  ...
  // Resolve best crest URL (explicit logoUrl -> registry crestUrl -> public API)
    ...
    <div className={`inline-flex items-center gap-2 ${className}`}>
      ...
      <div
        style={{
          ...
          borderColor: resolvedUrl ? 'rgba(0,0,0,0.1)' : branding.secondaryColor,
        }}
        className={`relative ${sizeConfig.box} ${sizeConfig.radius} shrink-0 flex items-center justify-center font-mono font-black shadow-sm overflow-hidden border border-white/20 select-none`}
      >
        {resolvedUrl ? (
